...
export OpFlow="
[举例] 微软win10中的msys2下 PrjD举例:  PrjD=d:\\tmp\\myprj #正确1  ;   PrjD="d:\tmp\myprj" #正确2  ;  PrjD=d:\tmp\myprj   #错误3
...
bash \$ToolD/new_PrjNodejsEnv_by_nodeenv.sh  \$PrjD \$NdVer    --> bash \$ToolD/create_vite_wrap.sh \$PrjD   --> source  \$PrjD/PrjNodeJsEnvActivate.sh   --> 正常执行yarn命令 
